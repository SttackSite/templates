...
def render():
    """Renderiza o template Interstellar - Site Pro"""

    # ✅ ALTERE: Configuração da Página (Título, Ícone, Layout)
    st.set_page_config(
        page_title="Site Pro | Interstellar Templates",  # ✅ ALTERE: Título da aba
        page_icon="🌌",                                   # ✅ ALTERE: Ícone da aba
        layout="wide"                                     # ❌ NÃO ALTERE
    )

    # ❌ NÃO ALTERE: CSS principal do template
    st.markdown("""
<style>
...
""", unsafe_allow_html=True)
    ...
    # ==================== HERO ====================
    # ✅ ALTERE: Hero - Mude os textos e URL do botão
    hero_html = '''<div class="hero-space" id="hero">
    ...
    # ==================== TEMPLATES / GALERIA ====================
    # ✅ ALTERE: Galeria - Mude os nomes, tiers e URLs dos cards
    ...
    render_ship(t_col1, "NEON PULSE",    "LEGENDARY", "https://images.unsplash.com/photo-1635070041078-e363dbe005cb?w=600")  # ✅ ALTERE: Nome, tier e imagem
    render_ship(t_col2, "QUANTUM SUITE", "EPIC",       "https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=600")  # ✅ ALTERE: Nome, tier e imagem
    render_ship(t_col3, "VOID MINIMAL",  "RARE",       "https://images.unsplash.com/photo-1634017839464-5c339ebe3cb4?w=600")  # ✅ ALTERE: Nome, tier e imagem
    st.markdown('</div>', unsafe_allow_html=True)

    # ==================== PROVA SOCIAL ====================
    # ✅ ALTERE: Estatísticas - Mude os números e labels
    stats_html = '''<div id="stats" style="background: rgba(0, 242, 255, 0.02); padding: 80px 8%; border-top: 1px solid var(--border-color); border-bottom: 1px solid var(--border-color);">
    ...
    # ==================== MISSÃO ====================
    # ✅ ALTERE: Objetivos - Mude os textos das missões
    ...
    mission_item("Quer criar seu próprio site e customizá-lo em minutos pelo menor preço de mercado.")  # ✅ ALTERE
    mission_item("Deseja trabalhar vendendo sites de elite para terceiros com alta margem.")  # ✅ ALTERE
    mission_item("Precisa escalar a conversão de seus produtos físicos ou digitais.")  # ✅ ALTERE
    st.markdown('</div>', unsafe_allow_html=True)

    # ==================== PASSO A PASSO ====================
    # ✅ ALTERE: Protocolo - Mude os títulos e descrições dos passos
    ...
    render_step("01", "DOWNLOAD DOS ASSETS",   "Após a compra, todos os templates são disponibilizados no seu painel de comando.")  # ✅ ALTERE
    render_step("02", "CUSTOMIZAÇÃO DE DADOS", "Siga nosso passo a passo visual para inserir suas informações e imagens.")  # ✅ ALTERE
    render_step("03", "DEPLOY EM SEGUNDOS",    "Configure sua URL personalizada e suba os arquivos para a rede global.")  # ✅ ALTERE
    render_step("04", "SISTEMA ONLINE",        "Seu site está no ar e pronto para operações em larga escala.")  # ✅ ALTERE
    st.markdown('</div>', unsafe_allow_html=True)

    # ==================== PREÇOS ====================
    # ✅ ALTERE: Preços - Mude os planos, valores e URLs dos botões
    ...
    with p_col1:
        ...
        """, unsafe_allow_html=True)  # ✅ ALTERE: Plano, preço e URL
    ...
    with st.expander("COMO É FEITA A TRANSFERÊNCIA DOS ARQUIVOS?"):
        st.write("Os códigos são entregues em formato digital pronto para deploy direto via GitHub ou hospedagens estáticas.")  # ✅ ALTERE

    with st.expander("TEREI SUPORTE NA CONFIGURAÇÃO DO DOMÍNIO?"):
        st.write("Sim, fornecemos manuais detalhados e suporte técnico para garantir que sua URL personalizada funcione perfeitamente.")  # ✅ ALTERE

    st.markdown('</div>', unsafe_allow_html=True)

    # ==================== FOOTER ====================
    # ✅ ALTERE: Footer - Mude o texto de copyright
    footer_html = '''<div style="padding: 60px 8%; text-align: center; border-top: 1px solid var(--border-color); opacity: 0.5;">
    ...
    <div style="text-align:center; padding: 60px 0 50px; background: #f8f9ff;">
        <a href="https://sttackedit.streamlit.app/?template=template5" target="_blank"
