...
def render():
    """Renderiza o template 25 - Plunder & Poach"""
    ...
    <div class="hero-pp">
        ...
        <h1 class="hero-title">FINALIZAMOS<br>O COMUM.</h1>
    ...
    <div id="estudio" style="background-color: #1a1a1a; color: #f4f1ea; padding: 150px 6%; text-align: center;">
        ...
        <div style="margin-top: 60px;">
            ...
            <a href="https://www.google.com/" target="_blank" class="action-button">Inicie sua Jornada</a>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div style="text-align:center; padding: 60px 0 50px; background: #f8f9ff;">
        <a href="https://sttackedit.streamlit.app/?template=template25" target="_blank"
